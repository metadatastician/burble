...
# TLC run script for ParticipantVoiceState — generated by tlaiser
...
echo "Running TLC on ParticipantVoiceState.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config ParticipantVoiceState.cfg ParticipantVoiceState.tla

...
# TLC run script for PeerNegotiation — generated by tlaiser
...
echo "Running TLC on PeerNegotiation.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config PeerNegotiation.cfg PeerNegotiation.tla

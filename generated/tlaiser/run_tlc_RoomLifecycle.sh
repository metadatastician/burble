...
# TLC run script for RoomLifecycle — generated by tlaiser
...
echo "Running TLC on RoomLifecycle.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config RoomLifecycle.cfg RoomLifecycle.tla
